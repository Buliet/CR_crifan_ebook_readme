...
OutputFolder = os.path.join("downloaded", "website")
# 'downloaded/pdf'
...
for curIdx, eachDocbookName in enumerate(uniqueDocbookNameList):
  curNum = curIdx + 1
  curDocbookPdfUrl = "https://www.crifan.com/files/doc/docbook/%s/release/html/%s.html.7z" % (eachDocbookName, eachDocbookName)
