...
* 文字版
    ...
    * 不同层次
      * 上层：纯软件
        * 通用
          ...
          * 字符编码
            * [详解](assets/pdf/char_encoding.pdf)
      ...
      * 中间：嵌入式
        ...
        * 开发期间=开发知识
          ...
          * [中断](assets/pdf/interrupt_related.pdf)
          * CPU
  ...
  * 非技术
    ...
    * 娱乐类
      * [羽毛球](assets/pdf/all_age_sports_badminton.pdf)
...
* [计算机编程语言基础知识](assets/pdf/programming_language_basic.pdf)
